...
/* when running the application because [] null, see if there is anything inside the user, if it has loads for the list, because I already logged in * /
/*quando roda a aplicação pois [] nulo, vejo se tem algo dentro de user, se tem carrega para lista, pois já logou*/
useEffect(()=> {
